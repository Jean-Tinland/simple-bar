...
export const data = {
  ...
  backgroundColorAsForegroundForWidgets: { label: 'Use background color as foreground for widgets', type: 'checkbox', fullWidth: true },
  backgroundColorAsForegroundForSpaces: { label: 'Use background color as foreground for spaces', type: 'checkbox', fullWidth: true },
  font: {
    label: 'Global font',
    type: 'text',
  ...
  hideSpaceLabelForNonEmpty: {label: 'Hide Space label for non empty spaces', type: 'checkbox', fullWidth: true},
  hideSticky: {label: 'Hide Sticky Windows', type: 'checkbox'},
...
export const defaultSettings = {
  global: {
    ...
    backgroundColorAsForegroundForSpaces: false,
    backgroundColorAsForegroundForWidgets: false,
    font: 'JetBrains Mono',
    fontSize: '11px',
  ...
  spacesDisplay: {
    ...
    hideSpaceLabelForNonEmpty: false,
    hideSticky: false
  },
  widgets: {
    processWidget: true,
