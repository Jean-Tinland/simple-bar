...
import { mergeDeep, hardRefresh, softRefresh } from './utils'
...
export const settingsData = {
  ...
  processWidget: { label: 'Process name', type: 'checkbox', hardRefresh: true },
  zoomWidget: { label: 'Zoom', type: 'checkbox', hardRefresh: true },
  timeWidget: { label: 'Time', type: 'checkbox', hardRefresh: true },
  dateWidget: { label: 'Date', type: 'checkbox', hardRefresh: true },
  wifiWidget: { label: 'Network', type: 'checkbox', hardRefresh: true },
  micWidget: { label: 'Microphone', type: 'checkbox', hardRefresh: true },
  soundWidget: { label: 'Sound', type: 'checkbox', hardRefresh: true },
  weatherWidget: { label: 'Weather', type: 'checkbox', hardRefresh: true },
  batteryWidget: { label: 'Battery', type: 'checkbox', hardRefresh: true },
  keyboardWidget: { label: 'Keyboard', type: 'checkbox', hardRefresh: true },
  spotifyWidget: { label: 'Spotify', type: 'checkbox', hardRefresh: true },
  musicWidget: { label: 'Music/iTunes', type: 'checkbox', hardRefresh: true },
  browserTrackWidget: { label: 'Browser track', type: 'checkbox', hardRefresh: true },
  vpnWidget: { label: 'VPN', type: 'checkbox', hardRefresh: true },
