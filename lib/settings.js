...
export const data = {
  ...
  showCurrentSpaceMode: {
    label: "Show current space mode (BSP, Stack, Float) (yabai only)",
    type: "checkbox",
    fullWidth: true,
  },
  hideWindowTitle: {
  ...
  displaySkhdMode: {
    label:
      "Display current skhd mode (requires some configuration, see readme file) (yabai only)",
    type: "checkbox",
    fullWidth: true,
  },
  displayStackIndex: {
    label:
      "Display stack-index for all processes in space (if greater than 0) (yabai only)",
    type: "checkbox",
    fullWidth: true,
  },
  displayOnlyCurrentStack: {
    label: "Display stack-index only for focused process (yabai only)",
    type: "checkbox",
    fullWidth: true,
  },
  ...
  displayAllSpacesOnAllScreens: {
    label: "Display all spaces on all screens (yabai only)",
    type: "checkbox",
    fullWidth: true,
  },
  hideEmptySpaces: { label: "Hide empty spaces", type: "checkbox" },
  showOptionsOnHover: {
    label: "Show space options on hover (yabai only)",
    type: "checkbox",
  },
  ...
  displayStickyWindowsSeparately: {
    label: "Display sticky windows separately (yabai only)",
    type: "checkbox",
    fullWidth: true,
  },
  hideCreateSpaceButton: {
    label: "Hide create space button (yabai only)",
    type: "checkbox",
    fullWidth: true,
  },
  widgets: {
