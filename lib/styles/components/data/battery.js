...
.simple-bar--no-color-in-data .battery--caffeinate .battery__charging-icon-outline-left,
.simple-bar--no-color-in-data .battery--caffeinate .battery__charging-icon-outline-right {
  fill: var(--white);
}
