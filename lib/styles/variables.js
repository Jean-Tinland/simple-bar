...
const { font, theme } = settings.global
...
:root {
  ...
  --transparent-dark: ${Theme[scheme].transparentt};
  --font: ${font !== '' ? font : Theme[scheme].defaultFont};
  ...
  --transition-easing: ${Theme[scheme].easing};
}
`
